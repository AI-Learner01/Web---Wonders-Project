    ...
    <div className="bg-white/95 backdrop-blur-xl border border-gray-200 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] p-4 w-full transition-all">
      <div className="flex flex-col lg:flex-row gap-3">
        ...
        <button
            ...
            className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 shadow-lg text-white px-8 py-4 rounded-2xl font-bold transition-all hover:scale-[1.02] active:scale-95"
        >
            Search
        </button>
      </div>
