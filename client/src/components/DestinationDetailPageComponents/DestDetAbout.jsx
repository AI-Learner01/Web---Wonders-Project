...
const DestDetAbout = ({aboutText, locationName}) => {
    ...
    useEffect(() => {
        ...
        const fetchAttractions = async () => {
            ...
            try {
                const response = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/destinations/attractions?name=${encodeURIComponent(locationName)}`,{ headers: { "ngrok-skip-browser-warning": "true" } });
